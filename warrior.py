...
class Warrior(WeaponUser):
	...
	def __init__(self, **kwargs):
		...
		self.known_commands.update({
			"defensive": self.apply_deffensive_stance,
			"aggressive": self.apply_aggressive_stance
		})
	...
	def apply_deffensive_stance(self, param):
		self.defensive_stance = True

	def apply_aggressive_stance(self, param):
		self.strong_blows = True
